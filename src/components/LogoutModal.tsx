...
const Logout = ({ visible, onCancel, onConfirm }: LogoutProps) => {
    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlay}>
        <View style={styles.container}>
          <Image style={styles.iconDelete} source={assetsNew.logoutModal} />

          <Text style={styles.title}>{t('logoutModal.title')}</Text>
          <Text style={styles.message}>{t('logoutModal.message')}</Text>

          <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.cancelButton} onPress={onCancel}>
              <Text style={styles.cancelText}>{t('logoutModal.cancel')}</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.confirmButton} onPress={onConfirm}>
              <Text style={styles.confirmText}>{t('logoutModal.confirm')}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>

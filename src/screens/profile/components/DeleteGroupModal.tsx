...
const DeleteGroupModal = ({ visible, onCancel, onConfirm }: DeleteGroupModalProps) => {
    ...
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlay}>
        <View style={styles.container}>
          <Image style={styles.iconDelete} source={assets.deleteGroup} />

          <Text style={styles.title}>{t('deleteGroupModal.title')}</Text>
          <Text style={styles.message}>{t('deleteGroupModal.message')}</Text>

          <View style={styles.buttonRow}>
            <TouchableOpacity style={styles.cancelButton} onPress={onCancel}>
              <Text style={styles.cancelText}>{t('deleteGroupModal.cancel')}</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.confirmButton} onPress={onConfirm}>
              <Text style={styles.confirmText}>{t('deleteGroupModal.confirm')}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
